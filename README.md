...
Hello!	|ใช่ไม่ได้ |	มีเครื่องหมายทางตรรกศาสตร์อยู่ในชื่อ	
w*h 	| ใช่ไม่ได้|	มีเครื่องหมายทางคณิตศาสตร์อยู่ในชื่อ			
time	| ใช้ได้|			
do	| ใช้ไม่ได้|	เป็นคำสงวน			
Do	| ใช้ได้|			
21November	|ใช้ไม่ได้ |มีตัวเลขอยู่หน้าชื่อตัวแปลไม่ได้			
ladkrabang	| ใช่ได้|			
Student ID	| ใช้ไม่ได้|ห้ามเว้นวรรคชื่อตัวเเปล			
...
```
##ผลที่ได้
![](https://github.com/tbnoung/LAB-07/blob/master/7.4.PNG)
...
Pluto |	5,945,900,000 km	|39.7269996981071|331.05833081756|	
##โปรเเกรมคำนวน
![](https://github.com/tbnoung/LAB-07/blob/master/7.5.PNG)
##คลาส Math 
